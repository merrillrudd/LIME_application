...
plot(x=seq_along(all_years), y=Report$F_t, lwd=2, col="blue", ylim=ylim, type="l", xaxt="n", ylab="Fishing mortality", xlab="Year", xaxs="i", yaxs="i", cex.axis=2, cex.lab=2)
...
sd[,2][which(is.na(sd[,2]))] <- 0
  ...
  plot(x=seq_along(all_years), y=Report$SB_t, lwd=2, col="blue", ylim=c(0, max(Report$SB_t)*1.5), type="l", xaxt="n", ylab="Relative spawning biomass", xlab="Year", xaxs="i", yaxs="i", cex.axis=2, cex.lab=2)
...
sd[,2][which(is.na(sd[,2]))] <- 0
  ...
  plot(x=1:length(Report$S_l), y=Report$S_l, lwd=2, col="blue", ylim=c(0, 1.1), type="l", xaxt="n", ylab="Selectivity at length", xlab="Length (cm)", xaxs="i", yaxs="i", cex.axis=2, cex.lab=2)
