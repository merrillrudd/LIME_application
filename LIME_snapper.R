...
plot_LCfits(LFlist=list('bottomlongline'=LC_bline))
...
### multinomial working for multi-fleet multiyear-- but unusually high certainty
...
## multinomial for multi-fleet one year
