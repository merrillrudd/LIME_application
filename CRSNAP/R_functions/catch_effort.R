...
data$Soak_time_hr <- sapply(1:nrow(data), function(x) calc_soak_time(time1=as.character(data$Calado_end_time[x]), time2=as.character(data$Virado_start_time[x]), hr=TRUE))
data$Soak_time_min <- sapply(1:nrow(data), function(x) calc_soak_time(time1=as.character(data$Calado_end_time[x]), time2=as.character(data$Virado_start_time[x]), hr=FALSE))
